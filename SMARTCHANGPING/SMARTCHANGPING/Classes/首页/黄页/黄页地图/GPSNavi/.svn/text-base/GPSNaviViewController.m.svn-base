...
- (void)setCoorinate:(CLLocationCoordinate2D)coorinate{
    _coorinate = coorinate;
    [self initProperties];
}
...
//    [self initDriveManager];
    ...
    self.endPoint = [AMapNaviPoint locationWithLatitude:_coorinate.latitude longitude:_coorinate.longitude];
